...
test("essential weather level blocks history and agronomic accumulation", async () => {
  ...
  try {
    ...
    for (const path of [
      ...
      "/api/weather/subjects/plantation/plantation-2026/agronomic-series?from=2026-08-01&to=2026-08-24",
    ]) {
