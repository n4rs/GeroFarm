...
- Rega/fertirrega: a validação de produção depende de o App Platform publicar o commit desta fase e aplicar `0015_irrigation.sql` com a ligação de migração autorizada.
