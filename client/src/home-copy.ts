...
export const en: HomepageCopy = {
  ...
  pricing: { kicker: "Clear plans", title: "Start small. Keep the whole operational history.", description: "No plan limits operations, harvests or field records. All paid plans allow future integrations, including GeroGrid when available.", monthly: "Monthly", annual: "Annual", annualNote: "Annual billing equals ten monthly payments", vat: "Prices exclude VAT.", recommended: "Most popular", consult: "On request", month: "/month", year: "/year", choose: "Choose plan", contact: "Request a proposal",
    plans: [
      { name: "Free", description: "A real 30-day start for one organisation.", monthly: "€0", annual: "€0", features: ["1 user", "10 ha", "5 active fields", "1 virtual station", "30 days maximum", "Consultation and export after the period", "Unlimited operations, harvests and field records"] },
      { name: "Grow", description: "For farms building a consistent digital routine.", monthly: "€24.90", annual: "€249", features: ["3 users", "100 ha", "50 fields", "2 virtual stations", "Privacy by Design included", "Inventory and Costs available as add-ons", "Future integrations allowed"] },
      { name: "Professional", description: "For larger teams and more complex operations.", monthly: "€69.90", annual: "€699", features: ["10 users", "500 ha", "250 fields", "5 virtual stations", "Privacy by Design included", "Inventory included", "Costs included", "Future integrations allowed"] },
      { name: "Custom", description: "Limits, integrations and modules tailored to the organisation.", monthly: "On request", annual: "On request", features: ["Custom users and area", "Custom fields and stations", "Privacy by Design included", "Inventory and Costs by proposal", "Tailored modules", "Future and tailored integrations"] }
    ],
    addonsTitle: "Add-ons for Grow and Custom", addons: ["Inventory · €9.90/month or €99/year", "Costs · €19.90/month or €199/year", "Inventory + Costs · €24.90/month or €249/year", "Additional virtual station on paid plans · €4.90/month or €49/year"], paidNote: "All paid plans include Privacy by Design, keep the full operational history and may use future integrations when they become available.", grace: "When a subscription ends, the organisation has a 7-day grace period with a notice at every sign-in." },
...
export const ptPT: HomepageCopy = {
  ...
  hero: { eyebrow: "Gestão completa no campo", title: "Gira cada plantação,", accent: "do mapa à colheita.", description: "Mapeie talhões, acompanhe plantações e registe operações, rega, fertilização, colheitas, lotes, equipas e equipamentos numa única aplicação.", primary: "Começar com o GeroFarm", secondary: "Ver planos", note: "Grátis até 30 dias · Sem cartão de crédito", imageAlt: "Campos agrícolas com limites de talhões mapeados e pontos de observação agronómica", mapLabel: "Talhões mapeados", cropLabel: "Plantações ativas", operationLabel: "Operações registadas" },
  ...
  pricing: { kicker: "Planos claros", title: "Comece pequeno. Preserve todo o histórico operacional.", description: "Nenhum plano limita operações, colheitas ou cadernos. Todos os planos pagos admitem integrações futuras, incluindo o GeroGrid quando estiver disponível.", monthly: "Mensal", annual: "Anual", annualNote: "O anual equivale a dez mensalidades", vat: "Preços sem IVA.", recommended: "Mais popular", consult: "Sob consulta", month: "/mês", year: "/ano", choose: "Escolher plano", contact: "Pedir proposta",
    plans: [
      { name: "Free", description: "Um início real de 30 dias para uma organização.", monthly: "0 €", annual: "0 €", features: ["1 utilizador", "10 ha", "5 talhões ativos", "1 estação virtual", "Máximo de 30 dias", "Consulta e exportação após o período", "Operações, colheitas e cadernos sem limite"] },
      { name: "Grow", description: "Para explorações a criar uma rotina digital consistente.", monthly: "24,90 €", annual: "249 €", features: ["3 utilizadores", "100 ha", "50 talhões", "2 estações virtuais", "Privacy by Design incluído", "Inventário e Custos disponíveis como addons", "Integrações futuras permitidas"] },
      { name: "Professional", description: "Para equipas maiores e operações mais complexas.", monthly: "69,90 €", annual: "699 €", features: ["10 utilizadores", "500 ha", "250 talhões", "5 estações virtuais", "Privacy by Design incluído", "Inventário incluído", "Custos incluídos", "Integrações futuras permitidas"] },
      { name: "Custom", description: "Limites, integrações e módulos à medida da organização.", monthly: "Sob consulta", annual: "Sob consulta", features: ["Utilizadores e área à medida", "Talhões e estações à medida", "Privacy by Design incluído", "Inventário e Custos sob proposta", "Módulos à medida", "Integrações futuras e à medida"] }
    ],
    addonsTitle: "Addons no Grow e Custom", addons: ["Inventário · 9,90 €/mês ou 99 €/ano", "Custos · 19,90 €/mês ou 199 €/ano", "Inventário + Custos · 24,90 €/mês ou 249 €/ano", "Estação virtual adicional nos planos pagos · 4,90 €/mês ou 49 €/ano"], paidNote: "Todos os planos pagos incluem Privacy by Design, preservam o histórico operacional completo e podem usar integrações futuras quando forem disponibilizadas.", grace: "Quando a subscrição termina, a organização tem 7 dias de tolerância com um aviso em cada entrada." },
