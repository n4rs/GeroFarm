...
export type HomepageCopy = {
  ...
  weather: { kicker: string; title: string; description: string; metrics: string[] };
  modules: { kicker: string; title: string; description: string; inventory: string; inventoryDesc: string; costs: string; costsDesc: string };
...
export const en: HomepageCopy = {
  ...
  hero: { eyebrow: "Farm management made simple", title: "Complete control,", accent: "without the complexity.", description: "Plan, record and follow every farm activity in one easy-to-use application, with full visibility across the holding and plans designed to stay accessible as you grow.", primary: "Start with GeroFarm", secondary: "View plans", note: "30-day free trial · No credit card required", imageAlt: "Agricultural fields with mapped parcel boundaries and agronomic observation points", mapLabel: "Mapped parcels", cropLabel: "Active crops", operationLabel: "Recorded operations" },
  ...
  platform: { kicker: "Daily farm management", title: "One application for the complete field cycle", description: "Plan, carry out and review the work with parcels, crops, resources and results in the same operational history.", cards: [
    ...
    { title: "Field record", description: "Build traceable records and evidence to support Integrated Production and Integrated Pest Management (IPM), organic production, GLOBALG.A.P. IFA, GRASP, SPRING and other applicable assurance schemes. Certification remains subject to the competent certification body.", status: "Available" }
  ] },
  weather: { kicker: "Agronomic weather", title: "Agronomic indicators for every crop", description: "Virtual stations calculate reference evapotranspiration, solar radiation, estimated DLI, growing degree days, chill requirements and estimated leaf wetness to support planning and monitoring. Values are estimates, not sensor measurements.", metrics: ["Reference evapotranspiration (ET₀)", "Solar radiation", "Estimated daily light integral (DLI)", "Growing degree days", "Chill requirements", "Estimated leaf wetness", "Indicators by crop"] },
  modules: { kicker: "Inventory and costs under control", title: "Know what you have, what you use and what it costs", description: "Follow stock and batches, connect every consumption to the work performed and turn labour, equipment and inputs into clear costs by crop and harvest.", inventory: "Inventory", inventoryDesc: "See available stock, batch traceability, purchases, movements and consumption, with each resource linked to the operation where it was used.", costs: "Costs", costsDesc: "Understand the real cost of each crop and harvest by bringing together labour, equipment, inputs and other resources without double counting." },
...
export const ptPT: HomepageCopy = {
  ...
  hero: { eyebrow: "Gestão agrícola sem complicações", title: "Toda a exploração,", accent: "sob controlo.", description: "Planeie, registe e acompanhe todo o trabalho agrícola numa aplicação simples de usar, com visão completa da exploração e planos acessíveis que crescem consigo.", primary: "Começar com o GeroFarm", secondary: "Ver planos", note: "30 dias gratuitos · Sem cartão de crédito", imageAlt: "Campos agrícolas com limites de talhões mapeados e pontos de observação agronómica", mapLabel: "Talhões mapeados", cropLabel: "Plantações ativas", operationLabel: "Operações registadas" },
  ...
  platform: { kicker: "Gestão agrícola diária", title: "Uma aplicação para todo o ciclo no campo", description: "Planeie, execute e reveja o trabalho com talhões, plantações, recursos e resultados no mesmo histórico operacional.", cards: [
    ...
    { title: "Caderno de campo", description: "Estruture registos e evidências rastreáveis para apoiar a PRODI, o MPB, GLOBALG.A.P. IFA, GRASP, SPRING e outros referenciais aplicáveis. A certificação continua sempre dependente do organismo competente.", status: "Disponível" }
  ] },
  weather: { kicker: "Meteorologia agronómica", title: "Indicadores agronómicos para cada plantação", description: "As estações virtuais calculam evapotranspiração de referência, radiação solar, DLI estimada, graus-dia, necessidades de frio e molhamento foliar estimado para apoiar o planeamento e a monitorização. Os valores são estimativas, não medições de sensores.", metrics: ["Evapotranspiração de referência (ET₀)", "Radiação solar", "DLI estimada", "Graus-dia", "Necessidades de frio", "Molhamento foliar estimado", "Indicadores por plantação"] },
  modules: { kicker: "Inventário e custos sob controlo", title: "Saiba o que tem, o que utiliza e quanto custa", description: "Acompanhe existências e lotes, ligue cada consumo ao trabalho realizado e transforme mão de obra, equipamentos e fatores em custos claros por plantação e colheita.", inventory: "Inventário", inventoryDesc: "Consulte existências, rastreabilidade de lotes, compras, movimentos e consumos, com cada recurso ligado à operação em que foi utilizado.", costs: "Custos", costsDesc: "Conheça o custo real de cada plantação e colheita, reunindo mão de obra, equipamentos, fatores e outros recursos sem dupla contabilização." },
