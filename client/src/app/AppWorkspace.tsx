...
function moduleNavigation(copy: HomepageCopy, common: ReturnType<typeof commonCopy>, privacyLabel: string, irrigationLabel: string, monitoringLabel:string, harvestLabel:string, notebookLabel:string): NavigationItem[] {
  return [
    ...
    { id: "plans", label: copy.nav.plans, short: "07" },
    { id: "weather", label: copy.nav.weather, short: "08" },
    { id: "harvests", label: harvestLabel, short: "09" },
    { id: "notebook", label: notebookLabel, short: "10" },
    { id: "resources", label: copy.platform.cards[6].title, short: "11", group: copy.modules.kicker },
    { id: "inventory", label: copy.modules.inventory, short: "12" },
    { id: "costs", label: copy.modules.costs, short: "13" },
    { id: "privacy", label: privacyLabel, short: "14" },
    { id: "settings", label: common.settings, short: "15" },
  ];
}
